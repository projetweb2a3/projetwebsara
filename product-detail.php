...
?>
  ...
  <?php echo' <img  src="data:image/jpeg;base64,'.base64_encode($item['image'] ).'" height="500" width="500" class="img-thumnail" />'?> 
 </div>
...
<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 ">
   ...
   <div class="ps-product__rating">
    ...
    <span class=""><h3 class="ps-product__price">Prix:  <?php echo number_format((float)$item['prix'], 3, '.', ''). ' DT';?></span></h3>
    <br>
 <div class="ps-product__desc">
     ...
     <div class="ps-product__status">
      <h5>Categorie: <span class="color"><?php echo $item['categorie'];?></span></p></h5>
                ...
                <div class="ps-product__shopping">
                  <form class="ps-form--shopping" action="http://warethemes.com/html/bready/do_action" method="post">
                    ...
                    <div class="ps-product__actions"><a class="mr-10" href="whishlist.html" data-tootip="Favorite"><i class="ba-heart"></i></a><a href="compare.html" title="Compare" data-tootip="Compare"><i class="ba-reload"></i></a></div>
                  </form>
                </div>
                <div class="ps-product__sharing"><a class="ps-btn ps-btn--yellow" href="cart.html">Order Now</a>
                    <?php echo '<a href="javascript:window.print()" class="ps-btn ps-btn--yellow">IMPRIMER</a>'; ?>
                  <br>
                  <br>
                  <br>
                  <p class="ps-product__sharing">Share this:<a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-dribbble"></i></a></p>
    ...
    <div class="ps-related-product">
      ...
      while ($product = $req->fetch(PDO::FETCH_ASSOC)) : 
        ...
        <?php echo  '<img  src="data:image/jpeg;base64,'.base64_encode($product['image'] ).'" height="50" width="100" class="img-thumnail" />';?> 
          ...
          <div class="ps-section__footer text-center"><a class="ps-btn" href="#">Load more</a></div>
        </div>
      </div>
    </div>
