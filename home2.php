...
<!-- Mirrored from warethemes.com/html/bready/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2019 22:11:44 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <nav class="navigation">
        <div class="ps-container">
          <div class="navigation__left">
            <ul class="menu">
              <li class="menu-item-has-children current-menu-item"><a href="home2.html">Homepage</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                <ul class="sub-menu">
                  <li><a href="home2.html">Homepage 1</a></li>
                  <li><a href="homepage-2.html">Homepage 2</a></li>
                  <li><a href="homepage-3.html">Homepage 3</a></li>
                </ul>
              </li>
              <li><a href="about-us.html">About</a></li>
              <li><a href="product-listing.php">Product</a>
                <ul class="sub-menu">
                  <li><a href="product-listing.php">Product Listing</a></li>
                  <li><a href="product-listing.php">Product Detail</a></li>
                </ul>
              </li>
              <li><a href="#">Pages</a>
                <ul class="sub-menu">
          ...
          <div class="navigation__center"><a class="ps-logo" href="home2.html"><img src="images/logo.png" alt=""></a></div>
    ...
    <div class="pb-80" id="slider">
      <div class="ps-carousel--animate ps-carousel--1st">
        <div class="item">
          <div class="ps-product--banner"><span class="ps-badge ps-badge--sale"><img src="" alt=""><i>0.5</i></span><img src="images/banner/slider-5.png" alt="">
            <div class="ps-product__footer"><a class="ps-btn" href="order-form.html">Order Now</a></div>
          </div>
        </div>
        <div class="item">
          <div class="ps-product--banner"><span class="ps-badge ps-badge--sale"><img src="" alt=""><i>50%</i></span><img src="images/banner/slider-6.png" alt="">
            <div class="ps-product__footer"><a class="ps-btn" href="order-form.html">Order Now</a></div>
          </div>
        </div>
      </div>
    ...
    <div class="ps-delivery-form bg--parallax" data-background="images/bg/delivery-form.jpg">
      <div class="ps-block--delivery">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
            <form class="ps-form--delivery" action="http://warethemes.com/html/bready/do_action" method="post">
              <h3>Delivery Now</h3>
        ...
        <div class="ps-container">
          <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
              <div class="ps-site-info"><a class="ps-logo" href="home2.html"><img src="images/logo-dark.png" alt=""></a>
